        ...
        <AdminLayout title="Faculty Leaves">
            <div className="admin-page">
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                    <h2 style={{ margin: 0 }}>Faculty Leave Applications</h2>
                    <input className="admin-search" placeholder="Search name / department / reason" value={query} onChange={e => setQuery(e.target.value)} />
                </div>
                ...
                <div className="card admin-card" style={{ padding: 12 }}>
                    <table className="data-table colorful-table" style={{ width: '100%' }}>
                        ...
                        <tbody>
                            {filtered.length === 0 && (
                                <tr><td colSpan={7} style={{ padding: 28, textAlign: 'center', color: '#6b7280' }}>No faculty leave applications.</td></tr>
                            )}
                            {filtered.map(l => (
