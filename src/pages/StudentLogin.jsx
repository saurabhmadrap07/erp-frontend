...
export default function StudentLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ensure only student accounts may login here
            ...
            <div className="auth-card">
                ...
                <div className="brand">
                    ...
                    <div>
                        ...
                        <div style={{ fontSize: 12, color: '#6b7280' }}>Student Portal</div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="auth-actions">
                        ...
                        <div style={{ display: 'flex', gap: 10, alignItems: 'center' }}>
                            <a href="/student-register" onClick={(e) => { e.preventDefault(); window.history.pushState({}, '', '/student-register'); window.dispatchEvent(new PopStateEvent('popstate')) }}>Register</a>
